...
namespace Quantum
{
    public unsafe partial class GroundBounceGameFXSummonFSM : GameFXSummonFSM
    {
        
        public GroundBounceGameFXSummonFSM()
        {
            SummonPositionOffset = new FPVector2(0, FP.FromString("0.2"));
            Name = "GameFXGroundBounce";
            IgnoreHitstop = true;
        }
