    ...
    public unsafe class GirlShotoFSM : PlayerFSM
    {
        ...
        public override void SetupStateMaps()
        {
            ...
            var _2MHits = new SectionGroup<Hit>()
            {
                Sections = new List<Tuple<int, Hit>>()
                {
                    ...
                    new Tuple<int, Hit>(5, new Hit()
                    {
                        ...
                        GravityScaling = 1,
                        VisualHitPositionOffset = new FPVector2(6, 3),
                        HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                        {
                            Sections = new List<Tuple<int, CollisionBoxCollection>>()
                            {
            ...
            var _2HHits = new SectionGroup<Hit>()
            {
                Sections = new List<Tuple<int, Hit>>()
                {
                    ...
                    new Tuple<int, Hit>(4, new Hit()
                    {
                        ...
                        Damage = highDamage,
                        VisualAngle = -80,
                        VisualHitPositionOffset = new FPVector2(1, 3),
                        HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                        {
                            Sections = new List<Tuple<int, CollisionBoxCollection>>()
                            {
                ...
                var hitboxes = new SectionGroup<Hit>()
                {
                    Sections = new List<Tuple<int, Hit>>()
                    {
                        ...
                        new(active, new Hit()
                        {
                            ...
                            VisualHitPositionOffset = new FPVector2(3, 6),
                            HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                            {
                                Sections = new List<Tuple<int, CollisionBoxCollection>>()
                                {
                ...
                var hitboxes = new SectionGroup<Hit>()
                {
                    Sections = new List<Tuple<int, Hit>>()
                    {
                        ...
                        new(active, new Hit()
                        {
                            ...
                            Damage = lowDamage,
                            DamageScaling = FP.FromString("0.5"), 
                            VisualHitPositionOffset = new FPVector2(2, 2),
                            HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                            {
                                Sections = new List<Tuple<int, CollisionBoxCollection>>()
                                {
            ...
            
            {
                ...
                var hit = new Hit()
                {
                    ...
                    HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                    {
                        Sections = new List<Tuple<int, CollisionBoxCollection>>()
                        {
                            new (active1, new CollisionBoxCollection()
                            {
                                CollisionBoxes = new List<CollisionBox>()
                                {
                                    new CollisionBox()
                ...
                var hurtType = new SectionGroup<HurtType>()
                {
                    Sections = new List<Tuple<int, HurtType>>()
                    {
                        new(startup + active1, HurtType.Counter),
                        new(20, HurtType.Punish)
                    }
                };
            ...
            
            {
                ...
                var crossup = new SectionGroup<bool>()
                {
                    Sections = new List<Tuple<int, bool>>()
                    {
                        new(startup, false),
                ...
                StateMapConfig.HurtTypeSectionGroup.Dictionary[state] = hurtType;
                StateMapConfig.MovementSectionGroup.Dictionary[state] = move;
                StateMapConfig.AllowCrossupSectionGroup.Dictionary[state] = crossup;
            }
                ...
                var hitboxes = new SectionGroup<Hit>()
                {
                    Sections = new List<Tuple<int, Hit>>()
                    {
                        ...
                        new(active, new Hit()
                        {
                            ...
                            GravityProration = FP.FromString("1.6"),
                            TrajectoryHeight = FP.FromString("2.75"),
                            TrajectoryXVelocity = FP.FromString("9"),
                            BlockPushback = FP.FromString("3"),
                            HitPushback = 3,
                            VisualAngle = -30,
                            Launches = true,
                            VisualHitPositionOffset = new FPVector2(5, 4),
                            // HardKnockdown = true,
                            // GroundBounce = true,
                            HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                            {
            ...
            
            {
                ...
                var hitboxCollections = new SectionGroup<CollisionBoxCollection>()
                {
                    Sections = new List<Tuple<int, CollisionBoxCollection>>()
                    {
                        new (active, new CollisionBoxCollection()
                ...
                var hitboxes = new SectionGroup<Hit>()
                {
                    Sections = new List<Tuple<int, Hit>>()
                    {
                        ...
                        new(active, new Hit()
                        {
                            ...
                            Damage = lowDamage,
                            DamageScaling = FP.FromString("0.5"), 
                            VisualHitPositionOffset = new FPVector2(4, 4),
                            HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                            {
                                Sections = new List<Tuple<int, CollisionBoxCollection>>()
                                {
            ...
            
            {
                ...
                var hitboxes = new SectionGroup<Hit>()
                {
                    Sections = new List<Tuple<int, Hit>>()
                    {
                        ...
                        new(active, new Hit()
                        {
                            ...
                            VisualAngle = 70,
                            GroundBounce = true,
                            VisualHitPositionOffset = new FPVector2(FP.FromString("2.75"), -2),
                            HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                            {
                                Sections = new List<Tuple<int, CollisionBoxCollection>>()
                                {
                ...
                StateMapConfig.CancellableAfter.Dictionary[state] = startup + 4;
                StateMapConfig.TrajectorySectionGroup.Dictionary[state] = trajectory;
                StateMapConfig.Pushbox.Dictionary[state] = pushbox;
            ...
            
            {
                ...
                var hit1 = new Hit()
                {
                    ...
                    Level = 2,
                    VisualHitPositionOffset = new FPVector2(FP.FromString("4.5"), 3),
                    HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                    {
                        Sections = new List<Tuple<int, CollisionBoxCollection>>()
                        {
                ...
                var hit2 = new Hit()
                {
                    ...
                    TrajectoryXVelocity = 3,
                    Level = 2,
                    VisualHitPositionOffset = new FPVector2(3, 2),
                    HitboxCollections = new SectionGroup<CollisionBoxCollection>()
                    {
                        Sections = new List<Tuple<int, CollisionBoxCollection>>()
                        {
