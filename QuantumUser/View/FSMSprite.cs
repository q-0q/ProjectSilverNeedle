    ...
    public override void OnUpdateView()
    {
        ...
        try
        {
            ...
            CameraTargetController.Instance.UpdatePlayerPos(pos, PredictedFrame.Get<PlayerLink>(EntityRef).Player,
                PredictedFrame.Get<DramaticData>(EntityRef).remaining, PredictedFrame.Get<DramaticData>(EntityRef).darkRemaining, PredictedFrame.Get<TrajectoryData>(EntityRef).groundBounce, fsm.Fsm.IsInState(PlayerFSM.PlayerState.AirHit), PredictedFrame);
